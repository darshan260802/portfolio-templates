...
function v(i) {
	...
	o[0] === s ? u = o[1] : (u = h(s), o[0] = s, o[1] = u);
	let d = u, f;
	o[2] === Symbol.for("react.memo_cache_sentinel") ? (f = { scope: l }, o[2] = f) : f = o[2], a(b, f);
	let p;
	...
	let x = s.headline || null, S;
	o[10] === x ? S = o[11] : (S = /* @__PURE__ */ t("p", {
	...
	let k;
	return o[24] !== w || o[25] !== O || o[26] !== p || o[27] !== _ || o[28] !== S ? (k = /* @__PURE__ */ n("header", {
		ref: l,
	...
	}), o[24] = w, o[25] = O, o[26] = p, o[27] = _, o[28] = S, o[29] = k) : k = o[29], k;
}
function y(e) {
	return /* @__PURE__ */ t("a", {
		href: e.url,
...
function E(o) {
	...
	let m;
	s[4] === c ? m = s[5] : (m = c.map(D), s[4] = c, s[5] = m);
	let h;
...
function P(r) {
	...
	let f;
	i[3] !== a.profile || i[4] !== a.socials ? (f = /* @__PURE__ */ t(v, {
		profile: a.profile,
		socials: a.socials
	}), i[3] = a.profile, i[4] = a.socials, i[5] = f) : f = i[5];
	let p;
	i[6] === a.experience ? p = i[7] : (p = a.experience && a.experience.length > 0 && /* @__PURE__ */ t(C, { experience: a.experience }), i[6] = a.experience, i[7] = p);
	let m;
	i[8] === a.projects ? m = i[9] : (m = a.projects && a.projects.length > 0 && /* @__PURE__ */ t(E, { projects: a.projects }), i[8] = a.projects, i[9] = m);
	let h;
	i[10] === a.skills ? h = i[11] : (h = a.skills && a.skills.length > 0 && /* @__PURE__ */ t(k, { skills: a.skills }), i[10] = a.skills, i[11] = h);
	let g;
	i[12] !== a.profile || i[13] !== a.socials ? (g = /* @__PURE__ */ t(M, {
		profile: a.profile,
		socials: a.socials
