...
export const manifest: TemplateManifest = {
	...
	name: "Instrument",
	description:
		"An achromatic instrument panel: pure black, hairline rules, zero corner radius, and a wall-sized extended-grotesk name. Scroll-velocity marquee, word-by-word summary scrub, spotlight project cards and magnetic skill chips — engineered rather than decorated.",
